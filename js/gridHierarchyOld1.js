  ...
  if ($.find("#tobeAppendend").length == 0){
      ...
      //  console.log(captions);
        $.each(captions, function(index,obj){
          ...
          if (parseInt(index) === 0){
            $("#tobeAppendend").append("<th rowspan="+obj.colspan+">"+obj.caption+"</th>"+dataArray[index].td);
          }
          else{
              $("body").append("<tr><th rowspan="+obj.colspan+">"+obj.caption+"</th>"+dataArray[index].td+"</tr>");
          }
